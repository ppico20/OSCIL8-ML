...
if not os.path.isfile('xgb_ak0_tilde.joblib'):
    ...
    tunning_xgb.to_csv('tuning_xgb_ak0_tilde.csv')
    ...
    # xgb = XGBRegressor(n_estimators= 158, max_depth = 9, random_state=0)
    xgb = load('xgb_ak0_tilde.joblib')

#xgb = XGBRegressor(n_estimators= 158, max_depth = 9, eta = 0.5, gamma = 0, random_state=0)
