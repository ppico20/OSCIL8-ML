...
log_file = 'log_HPT_Reg_rf_ak0_tilde.log'
...
if not os.path.isfile('rf_ak0_tilde.joblib'):
    ...
    tunning_rf.to_csv('tuning_rf_ak0_tilde.csv')
    ...
    # rf = RandomForestRegressor(n_estimators= 150, max_depth = 43, random_state=0)
