...
log_file = 'log_Reg_rf_ak0_tilde.log'
...
rf = load('rf_ak0_tilde.joblib')

tuning = pd.read_csv('tuning_rf_ak0_tilde.csv')
...
# ax1.set_ylim(160,10)
plt.tight_layout()
plt.savefig("HPT_map_rf_ak0_tilde.png", dpi=2000)
...
ax1.tick_params(direction='in', length=6, width=1)
plt.tight_layout()
plt.savefig("pred_rf_ak0_tilde.png", dpi=2000)
...
ax1.set_ylim(0, 0.65)
plt.tight_layout()
plt.savefig("feat_importance_rf_ak0_tilde.png", dpi=2000)
...
# fig.savefig("shap_rf_ak0_tilde.png", dpi=2000)
