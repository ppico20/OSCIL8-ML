...
log_file = 'log_Reg_xgb_Ek_tilde.log'
...
tuning = pd.read_csv('tuning_xgb_Ek_tilde.csv')
...
# ax1.set_ylim(160,10)
plt.tight_layout()
plt.savefig("HPT_map_xgb_Ek_tilde.png", dpi=2000)
...
ax1.tick_params(direction='in', length=6, width=1)
plt.tight_layout()
plt.savefig("pred_xgb_Ek_tilde.png", dpi=2000)
...
ax1.set_ylim(0, 0.4)
plt.tight_layout()
plt.savefig("feat_importance_xgb_Ek_tilde.png", dpi=2000)
...
fig.savefig("shap_xgb_Ek_tilde.png", dpi=2000)
