...
log_file = 'log_Reg_xgb_int_area.log'
...
xgb = XGBRegressor()
xgb = load('xgb_int_area.joblib')

tuning = pd.read_csv('tuning_xgb_int_area.csv')
...
# ax1.set_ylim(160,10)
plt.tight_layout()
plt.savefig("HPT_map_xgb_int_area.png", dpi=2000)
...
ax1.tick_params(direction='in', length=6, width=1)
plt.tight_layout()
plt.savefig("pred_xgb_int_area.png", dpi=2000)
...
ax1.set_ylim(0, 0.4)
plt.tight_layout()
plt.savefig("feat_importance_xgb_int_area.png", dpi=2000)
...
fig.savefig("shap_xgb_int_area.png", dpi=2000)
